...
export async function getImage(GOOGLE_CONSOLE_ID, GOOGLE_API_KEY, query) {
  ...
  var res = await axios.get(
    `https://www.googleapis.com/customsearch/v1?key=${GOOGLE_API_KEY}&cx=${GOOGLE_CONSOLE_ID}&q=${query}&fileType=jpeg|png|webp&imgType=photo&imgSize=medium&rights=cc_publicdomain|cc_attribute&imgColorType=color`
  );
